...
public class MkGw4PasswordDialog extends BaseDialog<DialogPasswordMkgw4Binding> {
    public static final String TAG = MkGw4PasswordDialog.class.getSimpleName();
    private final String FILTER_ASCII = "[ -~]*";
    private String password;

    public MkGw4PasswordDialog(Context context) {
        super(context);
    }
