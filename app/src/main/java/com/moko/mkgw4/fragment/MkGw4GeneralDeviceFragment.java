...
import com.moko.mkgw4.databinding.FragmentGeneralDeviceMkgw4Binding;
import com.moko.mkgw4.utils.ToastUtils;

public class MkGw4GeneralDeviceFragment extends Fragment {
    private static final String TAG = MkGw4GeneralDeviceFragment.class.getSimpleName();
    private FragmentGeneralDeviceMkgw4Binding mBind;
    private boolean cleanSession;
    private int qos;
    private int keepAlive;

    public MkGw4GeneralDeviceFragment() {
    }

    public static MkGw4GeneralDeviceFragment newInstance() {
        return new MkGw4GeneralDeviceFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.i(TAG, "onCreateView: ");
        mBind = FragmentGeneralDeviceMkgw4Binding.inflate(inflater, container, false);
