...
public class MkGw4DeviceListAdapter extends BaseQuickAdapter<MkGw4AdvInfo, BaseViewHolder> {
    public MkGw4DeviceListAdapter() {
        super(R.layout.mkgw4_list_item_device);
    }
    @SuppressLint("DefaultLocale")
    @Override
    protected void convert(BaseViewHolder helper, MkGw4AdvInfo item) {
