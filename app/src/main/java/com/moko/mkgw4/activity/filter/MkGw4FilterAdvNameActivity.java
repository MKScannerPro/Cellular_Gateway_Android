...
import com.moko.mkgw4.databinding.ActivityFilterAdvNameMkgw4Binding;
...
public class MkGw4FilterAdvNameActivity extends MkGw4BaseActivity {
    private final String FILTER_ASCII = "[ -~]*";
    private ActivityFilterAdvNameMkgw4Binding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = ActivityFilterAdvNameMkgw4Binding.inflate(getLayoutInflater());
                                ...
                                if (configKeyEnum == ParamsKeyEnum.KEY_FILTER_NAME_RULES) {
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterAdvName.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(this).inflate(R.layout.item_adv_name_filter_mkgw4, mBind.llDavName, false);
