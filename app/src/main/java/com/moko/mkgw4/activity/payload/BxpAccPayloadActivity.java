...
import com.moko.mkgw4.databinding.ActivityBxpAccPayloadMkgw4Binding;
 ...
 * @des:
 */
public class BxpAccPayloadActivity extends BaseActivity {
    private ActivityBxpAccPayloadMkgw4Binding mBind;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = ActivityBxpAccPayloadMkgw4Binding.inflate(getLayoutInflater());
