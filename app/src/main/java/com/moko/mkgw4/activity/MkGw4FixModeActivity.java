...
public class MkGw4FixModeActivity extends MkGw4BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind.tvPeriodicFix.setOnClickListener(v -> startActivity(new Intent(this, MkGw4PeriodicFixActivity.class)));
        mBind.tvMotionFix.setOnClickListener(v -> startActivity(new Intent(this, MkGw4MotionFixActivity.class)));
    }
