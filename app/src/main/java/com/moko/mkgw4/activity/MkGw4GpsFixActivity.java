...
public class MkGw4GpsFixActivity extends MkGw4BaseActivity {
                        ...
                        if (flag == 0x01) {
                            ...
                            switch (configKeyEnum) {
                                ...
                                case KEY_GPS_PDOP:
                                    ...
                                    if (savedParamsError) {
                                        ToastUtils.showToast(MkGw4GpsFixActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                    } else {
