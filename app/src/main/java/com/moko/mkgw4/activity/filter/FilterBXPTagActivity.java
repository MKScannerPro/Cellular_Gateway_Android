...
public class FilterBXPTagActivity extends BaseActivity {
                                ...
                                case KEY_FILTER_BXP_TAG_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(FilterBXPTagActivity.this).inflate(R.layout.item_tag_id_filter_mkgw4, mBind.llTagId, false);
