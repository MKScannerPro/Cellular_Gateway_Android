...
import com.moko.mkgw4.databinding.ActivityFilterIbeaconMkgw4Binding;
...
public class MkGw4FilterIBeaconActivity extends MkGw4BaseActivity {
    private ActivityFilterIbeaconMkgw4Binding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = ActivityFilterIbeaconMkgw4Binding.inflate(getLayoutInflater());
