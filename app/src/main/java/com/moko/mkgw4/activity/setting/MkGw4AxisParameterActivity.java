...
public class MkGw4AxisParameterActivity extends MkGw4BaseActivity {
    private ActivityAxisParameterMkgw4Binding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = ActivityAxisParameterMkgw4Binding.inflate(getLayoutInflater());
