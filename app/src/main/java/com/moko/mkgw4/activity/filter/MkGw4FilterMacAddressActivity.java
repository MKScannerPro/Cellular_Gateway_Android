...
public class MkGw4FilterMacAddressActivity extends MkGw4BaseActivity {
                                ...
                                case KEY_FILTER_MAC_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterMacAddress.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(MkGw4FilterMacAddressActivity.this).inflate(R.layout.item_mac_filter_mkgw4, mBind.llMacAddress, false);
