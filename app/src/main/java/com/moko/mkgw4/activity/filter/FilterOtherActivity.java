...
import com.moko.mkgw4.databinding.ActivityFilterOtherMkgw4Binding;
...
public class FilterOtherActivity extends BaseActivity {
    private ActivityFilterOtherMkgw4Binding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = ActivityFilterOtherMkgw4Binding.inflate(getLayoutInflater());
                                ...
                                case KEY_FILTER_OTHER_RULES:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterOther.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(this).inflate(R.layout.item_other_filter_mkgw4, mBind.llFilterCondition, false);
