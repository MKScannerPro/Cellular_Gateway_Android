...
import com.moko.mkgw4.databinding.ActivityEddystoneUrlPayloadMkgw4Binding;
 ...
 * @des:
 */
public class EddystoneUrlPayloadActivity extends BaseActivity {
    private ActivityEddystoneUrlPayloadMkgw4Binding mBind;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = ActivityEddystoneUrlPayloadMkgw4Binding.inflate(getLayoutInflater());
