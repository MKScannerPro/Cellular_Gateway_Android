...
public class MkGw4AdvInfoAnalysisImpl implements DeviceInfoParseable<MkGw4AdvInfo> {
    private final HashMap<String, MkGw4AdvInfo> advInfoHashMap;

    public MkGw4AdvInfoAnalysisImpl() {
        this.advInfoHashMap = new HashMap<>();
    }

    @Override
    public MkGw4AdvInfo parseDeviceInfo(DeviceInfo deviceInfo) {
