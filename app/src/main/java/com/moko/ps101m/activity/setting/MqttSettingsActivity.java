...
import com.moko.ps101m.databinding.ActivityMqttSettingsBinding;
...
public class MqttSettingsActivity extends PS101BaseActivity implements RadioGroup.OnCheckedChangeListener {
    private ActivityMqttSettingsBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = ActivityMqttSettingsBinding.inflate(getLayoutInflater());
            ...
            if (intent != null) {
                ...
                if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)) {
                    ...
                    if (blueState == BluetoothAdapter.STATE_TURNING_OFF) {
                        dismissSyncProgressDialog();
                        AlertDialog.Builder builder = new AlertDialog.Builder(MqttSettingsActivity.this);
                        builder.setTitle("Dismiss");
                        builder.setCancelable(false);
                        builder.setMessage("The current system of bluetooth is not available!");
                        builder.setPositiveButton("OK", (dialog, which) -> {
                            MqttSettingsActivity.this.setResult(RESULT_OK);
                            finish();
                        });
                        builder.show();
                    }
