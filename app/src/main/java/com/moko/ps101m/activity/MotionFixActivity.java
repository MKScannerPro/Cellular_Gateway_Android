...
import com.moko.ps101m.databinding.ActivityMotionFixBinding;
 ...
 * @des:
 */
public class MotionFixActivity extends PS101BaseActivity {
    private ActivityMotionFixBinding mBind;
    private boolean mSavedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = ActivityMotionFixBinding.inflate(getLayoutInflater());
